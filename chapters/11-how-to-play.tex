...
action. Count each tag that clearly applies and add one die for it. A
tag can come from Body, Stuff, Skills, or Magic. The small mark on its
oval shows its source; \atrtag{body}{Strong} and \atrtag{magic}{Fire}
both add one die when they apply.
...
before you count your tags. An item may still supply the base Stat while
you use tags from another column.
