...
Every character has three broad base \keyword{Stats}, each from \dice{1}
to \dice{5}. Your Body rank sets \keyword{Body}; your Skills rank buys
\keyword{Mind} and \keyword{Face}.
...
Stats. The \keyword{Body} column sets your Body Stat, and the
\keyword{Skills} column buys your Mind and Face; \keyword{Stuff} and
\keyword{Magic} never touch them. The Stats --- Body, Mind, Face --- are
what you actually roll.
\end{notebox}
