...
\begin{notebox}[More Reskins to Come]
% Signposts the pattern: the other Stuff categories and columns follow here.
\textbf{To do:} extend this section with the realm's take on Weapons, Armour,
Lifestyle, and Locations, then on Body, Skills, and Magic.
\end{notebox}
