...
capabilities: flight, breathing in the void, walking on walls. At Body
\rating{3} you choose \dice{1} Special Feat; at Body \rating{4} you
choose \dice{2} in total. Body is not the only column that grants them
--- Skills, Magic, and Stuff all do too, at the same ranks --- so the
rules, and each column's list of Feats, live in their own chapter:
\emph{Special Feats}.
