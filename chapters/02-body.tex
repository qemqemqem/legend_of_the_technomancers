...
\begin{example}
Kira is Body \rating{2}: \dice{2} points. She raises Face from \dice{1} to
\dice{2} (\dice{1} point) and Mind from \dice{1} to \dice{2}
(\dice{1} point): \textbf{Body~1, Mind~2, Face~2}.
\end{example}
